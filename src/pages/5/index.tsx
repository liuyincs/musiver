...
const features = [
  { num: '01', title: '全平台覆盖', desc: 'iOS、Android、macOS、Windows、Linux — 一次配置，处处聆听，体验始终如一。' },
  { num: '02', title: '多源连接', desc: '同时连接 Navidrome、Subsonic、Jellyfin 等多种 NAS 音乐服务器，统一管理。' },
  { num: '03', title: '品质至上', desc: '支持无损音频解码，搭配智能缓存与离线模式，聆听体验不打折。' },
];

export default function Page5(): ReactNode {
  return (
